...
import {
  ...
  MyTableComponent3,
  MyTableConfig3,
} from '../my-table-component3/my-table-component3';
...
import {
  MyButtonConfig,
  MyButtonComponent,
} from '../my-button-component/my-button-component';
...
export class Welcome5 {
  ...
  filterData(): void {
    this.dataService
      .getFilteredData(this.searchTerm, this.tableConfig.search.columns || [])
      .subscribe((filtered) => {
